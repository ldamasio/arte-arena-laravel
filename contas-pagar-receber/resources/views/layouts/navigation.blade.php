            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('arte-arena.webp') }}" alt="Arte Arena" class="block h-9 w-auto">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('contas.index')" :active="request()->routeIs('dashboard')">
                        Listas Contas
                    </x-nav-link>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('contas.relatorios')" :active="request()->routeIs('dashboard')">
                        Relatórios
                    </x-nav-link>
                </div>
                @endif
